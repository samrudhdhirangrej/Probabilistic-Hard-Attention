...
class GlimpseLoc(nn.Module):
    def __init__(self, nf, maxloc, gsz, full=False):
        ...
        self.fcg.add_module('1',  nn.Conv2d(3, 64, 3))    
        self.fcg.add_module('2',  nn.LeakyReLU())
        self.fcg.add_module('3',  nn.BatchNorm2d(64))
        self.fcg.add_module('4',  nn.Conv2d(64, 128, 3))  
        self.fcg.add_module('5',  nn.LeakyReLU())
        self.fcg.add_module('6',  nn.BatchNorm2d(128))
        self.fcg.add_module('7',  nn.Conv2d(128, 256, 3)) 
        self.fcg.add_module('8',  nn.LeakyReLU())
        self.fcg.add_module('9',  nn.BatchNorm2d(256))
        if gsz==8:
            self.fcg.add_module('10', nn.Conv2d(256, nf, 2, stride=4))
        else:
            self.fcg.add_module('10',  nn.Conv2d(256, 256, 3))  
            self.fcg.add_module('11',  nn.LeakyReLU())
            self.fcg.add_module('12',  nn.BatchNorm2d(256))
            self.fcg.add_module('13',  nn.Conv2d(256, 256, 3)) 
            self.fcg.add_module('14',  nn.LeakyReLU())
            self.fcg.add_module('15',  nn.BatchNorm2d(256))
            self.fcg.add_module('16',  nn.Conv2d(256, 256, 3)) 
            self.fcg.add_module('17',  nn.LeakyReLU())
            self.fcg.add_module('18',  nn.BatchNorm2d(256))
            self.fcg.add_module('19',  nn.Conv2d(256, 256, 3))
            self.fcg.add_module('20',  nn.LeakyReLU())
            self.fcg.add_module('21',  nn.BatchNorm2d(256))
            self.fcg.add_module('22',  nn.Conv2d(256, nf, 2, stride=8))
